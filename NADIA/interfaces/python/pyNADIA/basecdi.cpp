...
static void __pyx_pf_7pyNADIA_7basecdi_9PyBaseCDI___dealloc__(CYTHON_UNUSED struct __pyx_obj_7pyNADIA_7basecdi_PyBaseCDI *__pyx_v_self); /* proto */
static PyObject *__pyx_tp_new_7pyNADIA_7basecdi_PyBaseCDI(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static char __pyx_k_1[] = "! @package pyNADIA.basecdi\nEmpty placeholder Python wrapper BaseCDI class. \n";
...
static void __pyx_pf_7pyNADIA_7basecdi_9PyBaseCDI___dealloc__(CYTHON_UNUSED struct __pyx_obj_7pyNADIA_7basecdi_PyBaseCDI *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("basecdi"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_1), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
