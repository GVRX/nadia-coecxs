...
cdef extern from "io.h":
    cdef void read_image(string filename, Double_2D & data)
    ...
    cdef void write_image(string file_name, const Double_2D & data)
    cdef void write_image(string file_name, const Double_2D & data, bool log_scale)
    cdef void write_image(string file_name, const Double_2D & data, bool log_scale, double min, double max)
