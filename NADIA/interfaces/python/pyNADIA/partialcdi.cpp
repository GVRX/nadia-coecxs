 ...
 */
  try {
    __pyx_t_4 = new __pyx_t_7pyNADIA_9complex2d_Complex_2D(__pyx_v_self->thisptr->get_transmission());
  } catch(...) {
    __Pyx_CppExn2PyErr();
 ...
 */
  try {
    __pyx_t_4 = new __pyx_t_7pyNADIA_9complex2d_Complex_2D(__pyx_v_self->thisptr->get_mode(__pyx_v_modenum));
  } catch(...) {
    __Pyx_CppExn2PyErr();
